...
// CarouselDoc.cpp : implementation of the CCarouselDoc class
//
...
// CCarouselDoc construction/destruction

CCarouselDoc::CCarouselDoc() noexcept
{
...
void CCarouselDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CCarouselDoc::InitializeSearchContent()
{
...
void CCarouselDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
