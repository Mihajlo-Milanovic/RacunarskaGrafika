...
void CCarouselView::OnDraw(CDC* pDC)
{
	...
	//Scale(memDC, 3, 3, false);
	
	unsigned short bits[16] = { -0x0100, -0x0100, -0x0100, -0x0100,
								...
								//65535 - 255, 65535 - 255, 65535 - 255, 65535 - 255, 
								//65535 - 255, 65535 - 255, 65535 - 255, 65535 - 255,
								//255, 255, 255, 255,
								//255, 255, 255, 255 
								};
	CBitmap brushBmp;
	brushBmp.CreateBitmap(16, 16, 1, 1, bits);
	CBrush brush;
	brush.CreatePatternBrush(&brushBmp);
	CBrush* pOldBrush = memDC->SelectObject(&brush);
	memDC->Rectangle(0, 0, 256, 256);
	memDC->SelectObject(pOldBrush);

	//Scale(memDC, 1/3, 1/3, false);
