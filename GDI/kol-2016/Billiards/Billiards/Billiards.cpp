...
BEGIN_MESSAGE_MAP(CBilliardsApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CBilliardsApp::OnAppAbout)
...
CBilliardsApp::CBilliardsApp() noexcept
{
	...
	SetAppID(_T("Billiards.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CBilliardsApp object

CBilliardsApp theApp;


// CBilliardsApp initialization
...
int CBilliardsApp::ExitInstance()
{
...
// CBilliardsApp message handlers
