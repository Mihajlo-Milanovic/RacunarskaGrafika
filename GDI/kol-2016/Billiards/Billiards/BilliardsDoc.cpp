...
CBilliardsDoc::CBilliardsDoc() noexcept
{
...
void CBilliardsDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CBilliardsDoc::InitializeSearchContent()
{
...
void CBilliardsDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
